...
def fitness_function(routes):
    ...
    for route in routes:
        ...
        distance += matriz_distancias[prev_location][20]  # Regresa al almacén
        total_distance += distance
        # Esto para que el fitness se base en el coste total de la ruta, no hay mucha mejora en realidad
    #     route_cost = distance * vehicle["costo_km"]  # Costo de la ruta
...
def generate_initial_population():
    population = []
    clients = list(range(0, num_clients + 1))
...
def genetic_algorithm_multiple_runs(ejecuciones=20):
    ...
    for datos in info_mejor_ruta:
        ...
        print(f"  Demanda total: {datos['demanda_total']}kg")
